...
11. [bootstrap sass documentation](https://getbootstrap.com/docs/5.2/customize/sass/) - (src/public/css/styles.css) and (src/public/scss/custom.scss)
...
15. [bootstrap grid system documentation](https://getbootstrap.com/docs/4.0/layout/grid/) - (src/views/layout.hbs) and (src/views/collection.hbs)
16. [bootstrap radio buttons documentation](https://getbootstrap.com/docs/5.0/forms/checks-radios/) - (src/views/battle-lose.hbs)
17. [bootstrap position documentation](https://getbootstrap.com/docs/4.0/utilities/position/) - (src/views)
18. [w3schools bootstrap tutorial on radio buttons](https://www.w3schools.com/tags/att_input_type_radio.asp) - (src/views/battle-lose.hbs)
19. [w3schools favicon tutorial](https://www.w3schools.com/html/html_favicon.asp) - (src/views/layout.hbs)
20. [sass official guide](https://sass-lang.com/guide) - (src/public/scss/custom.scss)
21. [bootstrap color customization video tutorial](https://www.youtube.com/watch?v=au5ccstcbnc&ab_channel=PixelRocket) - (src/public/scss/custom.scss)
22. [changing size of bootstrap alert stack overflow](https://stackoverflow.com/questions/38379166/set-size-and-center-alert-box-in-twitter-bootstrap) - (src/public/scss/custom.scss)
23. [bootstrap width classes stack overflow](https://stackoverflow.com/questions/39033326/width-of-inputs-in-inline-form-bootstrap-4) - (src/views/battle.hbs)
24. [google fonts api documentation](https://developers.google.com/fonts/docs/getting_started) - (src/views/layout.hbs)
25. [resolve google fonts api issue stack overflow](https://stackoverflow.com/questions/46268657/google-webfont-only-works-locally) - (src/views/layout.hbs)
