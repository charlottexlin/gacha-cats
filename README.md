...
1. [user authentication code from passport.js authentication docs](http://passportjs.org/docs) - [src/app.mjs](src/app.mjs) and [src/auth.mjs](src/auth.mjs)
2. [user authentication code from Professor Versoza's slides on passport.js](https://cs.nyu.edu/courses/fall22/CSCI-UA.0467-001/_site/slides/16/auth.html#/) - [src/app.mjs](src/app.mjs) and [src/auth.mjs](src/auth.mjs)
3. [creating schemas from mongoose documentation](https://mongoosejs.com/docs) - [src/db.mjs](src/db.mjs)
4. [how to push items onto an array in a mongoDB document stack overflow](https://stackoverflow.com/questions/33049707/push-items-into-mongo-array-via-mongoose) - [src/app.mjs](src/app.mjs)
5. [chance.js documentation](https://chancejs.com/usage/node.html): using chanceJS - [src/gacha.mjs](src/gacha.mjs), [src/battle.mjs](src/battle.mjs), and [src/opponentProfiles.mjs](src/opponentProfiles.mjs)
6. [chance.js documentation for 'weighted' function](https://chancejs.com/miscellaneous/weighted.html) - [src/gacha.mjs](src/gacha.mjs) and [src/battle.mjs](src/battle.mjs)
7. [chance.js documentation for 'pickOne' function](https://chancejs.com/helpers/pickone.html) - [src/opponentProfiles.mjs](src/opponentProfiles.mjs)
8. [memorystore documentation](https://www.npmjs.com/package/memorystore) - [src/app.mjs](src/app.mjs)
9. [code to use fetch API (both sending request and creating the API itself) from MDN docs for Fetch API](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API/Using_Fetch) - [src/public/javascripts/collection.js](src/public/javascripts/collection.js) and [src/app.mjs](src/app.mjs)
10. [input validation/sanitization code from validator documentation](https://www.npmjs.com/package/validator) - [src/app.mjs](src/app.mjs)
11. [reference for setting up custom theme from bootstrap sass documentation](https://getbootstrap.com/docs/5.2/customize/sass/) - [src/public/css/styles.css](src/public/css/styles.css) and [src/public/scss/custom.scss](src/public/scss/custom.scss)
12. [reference for setting up custom theme from bootstrap customization with sass video tutorial](https://www.youtube.com/watch?v=6Ovw43Dkp44&ab_channel=Academind) - [src/public/scss/custom.scss](src/public/scss/custom.scss)
13. [reference for how to use various bootstrap classes from tutorial republic bootstrap tutorial](https://www.tutorialrepublic.com/twitter-bootstrap-tutorial/) - [src/views](src/views)
14. [mdbootstrap tutorial on margins](https://mdbootstrap.com/docs/standard/extended/margin/) - [src/views/layout.hbs](src/views/layout.hbs)
15. [bootstrap grid system documentation](https://getbootstrap.com/docs/4.0/layout/grid/) - [src/views/layout.hbs](src/views/layout.hbs) and [src/views/collection.hbs](src/views/collection.hbs)
16. [bootstrap radio buttons documentation](https://getbootstrap.com/docs/5.0/forms/checks-radios/) - [src/views/battle-lose.hbs](src/views/battle-lose.hbs)
17. [bootstrap position documentation](https://getbootstrap.com/docs/4.0/utilities/position/) - [src/views](src/views)
18. [w3schools bootstrap tutorial on radio buttons](https://www.w3schools.com/tags/att_input_type_radio.asp) - [src/views/battle-lose.hbs](src/views/battle-lose.hbs)
19. [code for changing favicon from w3schools favicon tutorial](https://www.w3schools.com/html/html_favicon.asp) - [src/views/layout.hbs](src/views/layout.hbs)
20. [reference for using an scss file for a custom bootstrap theme from sass official guide](https://sass-lang.com/guide) - [src/public/scss/custom.scss](src/public/scss/custom.scss)
21. [bootstrap color customization video tutorial](https://www.youtube.com/watch?v=au5ccstcbnc&ab_channel=PixelRocket) - [src/public/scss/custom.scss](src/public/scss/custom.scss)
22. [changing size of bootstrap alert stack overflow](https://stackoverflow.com/questions/38379166/set-size-and-center-alert-box-in-twitter-bootstrap) - [src/public/scss/custom.scss](src/public/scss/custom.scss)
23. [bootstrap width classes stack overflow](https://stackoverflow.com/questions/39033326/width-of-inputs-in-inline-form-bootstrap-4) - [src/views/battle.hbs](src/views/battle.hbs)
24. [google fonts api documentation](https://developers.google.com/fonts/docs/getting_started) - [src/views/layout.hbs](src/views/layout.hbs)
25. [resolve google fonts api issue stack overflow](https://stackoverflow.com/questions/46268657/google-webfont-only-works-locally) - [src/views/layout.hbs](src/views/layout.hbs)
26. [bootstrap optimization recommendations from bootstrap](https://getbootstrap.com/docs/5.0/customize/optimize/)
...
29. [mongoose save bug fix using markModified stack overflow](https://stackoverflow.com/questions/38563597/mongoose-not-saving-data-with-no-error) - [src/app.mjs](src/app.mjs)