...
1. [passport.js authentication docs](http://passportjs.org/docs) - [src/app.mjs](src/app.mjs) and [src/auth.mjs](src/auth.mjs)
2. [Professor Versoza's slides on passport.js](https://cs.nyu.edu/courses/fall22/CSCI-UA.0467-001/_site/slides/16/auth.html#/) - [src/app.mjs](src/app.mjs) and [src/auth.mjs](src/auth.mjs)
3. [mongoose documentation](https://mongoosejs.com/docs)  - [src/db.mjs](src/db.mjs)
4. [mongoose stack overflow](https://stackoverflow.com/questions/33049707/push-items-into-mongo-array-via-mongoose) - [src/app.mjs](src/app.mjs)
5. [chance.js documentation](https://chancejs.com/usage/node.html) - [src/gacha.mjs](src/gacha.mjs), [src/battle.mjs](src/battle.mjs), and [src/opponentProfiles.mjs](src/opponentProfiles.mjs)
...
9. [MDN docs for Fetch API](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API/Using_Fetch) - [src/public/javascripts/collection.js](src/public/javascripts/collection.js) and [src/app.mjs](src/app.mjs)
10. [validator documentation](https://www.npmjs.com/package/validator) - [src/app.mjs](src/app.mjs)
11. [bootstrap sass documentation](https://getbootstrap.com/docs/5.2/customize/sass/) - [src/public/css/styles.css](src/public/css/styles.css) and [src/public/scss/custom.scss](src/public/scss/custom.scss)
12. [bootstrap customization with sass video tutorial](https://www.youtube.com/watch?v=6Ovw43Dkp44&ab_channel=Academind) - [src/public/scss/custom.scss](src/public/scss/custom.scss)
13. [tutorial republic bootstrap tutorial](https://www.tutorialrepublic.com/twitter-bootstrap-tutorial/) - [src/views](src/views)
...
19. [w3schools favicon tutorial](https://www.w3schools.com/html/html_favicon.asp) - [src/views/layout.hbs](src/views/layout.hbs)
20. [sass official guide](https://sass-lang.com/guide) - [src/public/scss/custom.scss](src/public/scss/custom.scss)
...
29. [mongoose save bug fix stack overflow](https://stackoverflow.com/questions/38563597/mongoose-not-saving-data-with-no-error) - [src/app.mjs](src/app.mjs)